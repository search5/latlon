...
def demonstration():
    ...
    print(repr(palmyra))  # Returns 'Latitude 5.8833, Longitude -162.0833'
    ...
    # Print coordinates to degree minute second (returns ('5 52 59.88 N', '162 4 59.88 W'))
    ...
    # Print coordinates as degree minutes separated by underscore (returns ('5_52.998', '-162_4.998'))
